...
if(typeof cljs.core.async.impl.ioc_helpers.t35164 !== 'undefined'){
} else {

/**
* @constructor
*/
cljs.core.async.impl.ioc_helpers.t35164 = (function (f,fn_handler,meta35165){
this.f = f;
...
cljs.core.async.impl.ioc_helpers.t35164.prototype.cljs$core$async$impl$protocols$Handler$ = true;

cljs.core.async.impl.ioc_helpers.t35164.prototype.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

cljs.core.async.impl.ioc_helpers.t35164.prototype.cljs$core$async$impl$protocols$Handler$commit$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.f;
});

cljs.core.async.impl.ioc_helpers.t35164.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35166){
var self__ = this;
var _35166__$1 = this;
return self__.meta35165;
});

cljs.core.async.impl.ioc_helpers.t35164.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35166,meta35165__$1){
var self__ = this;
var _35166__$1 = this;
return (new cljs.core.async.impl.ioc_helpers.t35164(self__.f,self__.fn_handler,meta35165__$1));
});

cljs.core.async.impl.ioc_helpers.t35164.cljs$lang$type = true;

cljs.core.async.impl.ioc_helpers.t35164.cljs$lang$ctorStr = "cljs.core.async.impl.ioc-helpers/t35164";

cljs.core.async.impl.ioc_helpers.t35164.cljs$lang$ctorPrWriter = (function (this__4838__auto__,writer__4839__auto__,opt__4840__auto__){
return cljs.core._write(writer__4839__auto__,"cljs.core.async.impl.ioc-helpers/t35164");
});

cljs.core.async.impl.ioc_helpers.__GT_t35164 = (function __GT_t35164(f__$1,fn_handler__$1,meta35165){
return (new cljs.core.async.impl.ioc_helpers.t35164(f__$1,fn_handler__$1,meta35165));
});

}

return (new cljs.core.async.impl.ioc_helpers.t35164(f,fn_handler,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$8,19,cljs.core.constant$keyword$9,30,cljs.core.constant$keyword$10,3,cljs.core.constant$keyword$11,27,cljs.core.constant$keyword$12,"/home/juho/Source/lomakkeet/example/target/cljsbuild-adv/public/js/out/cljs/core/async/impl/ioc_helpers.cljs"], null)));
});
...
var statearr_35172_35175 = state;
(statearr_35172_35175[cljs.core.async.impl.ioc_helpers.VALUE_IDX] = x);

(statearr_35172_35175[cljs.core.async.impl.ioc_helpers.STATE_IDX] = blk);
...
var statearr_35173_35176 = state;
(statearr_35173_35176[cljs.core.async.impl.ioc_helpers.VALUE_IDX] = (function (){var G__35174 = cb;
return (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(G__35174) : cljs.core.deref.call(null,G__35174));
})());

(statearr_35173_35176[cljs.core.async.impl.ioc_helpers.STATE_IDX] = blk);
...
(statearr_35180_35183[cljs.core.async.impl.ioc_helpers.VALUE_IDX] = ret_val);
...
cljs.core.async.impl.ioc_helpers.ExceptionFrame.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4856__auto__,k35186,else__4857__auto__){
var self__ = this;
var this__4856__auto____$1 = this;
var G__35188 = (((k35186 instanceof cljs.core.Keyword))?k35186.fqn:null);
switch (G__35188) {
case "prev":
return self__.prev;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k35186,else__4857__auto__);
...
cljs.core.async.impl.ioc_helpers.ExceptionFrame.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4861__auto__,k__4862__auto__,G__35185){
var self__ = this;
var this__4861__auto____$1 = this;
var pred__35189 = cljs.core.keyword_identical_QMARK_;
var expr__35190 = k__4862__auto__;
if(cljs.core.truth_((function (){var G__35192 = cljs.core.constant$keyword$100;
var G__35193 = expr__35190;
return (pred__35189.cljs$core$IFn$_invoke$arity$2 ? pred__35189.cljs$core$IFn$_invoke$arity$2(G__35192,G__35193) : pred__35189.call(null,G__35192,G__35193));
})())){
...
if(cljs.core.truth_((function (){var G__35194 = cljs.core.constant$keyword$101;
var G__35195 = expr__35190;
return (pred__35189.cljs$core$IFn$_invoke$arity$2 ? pred__35189.cljs$core$IFn$_invoke$arity$2(G__35194,G__35195) : pred__35189.call(null,G__35194,G__35195));
})())){
...
if(cljs.core.truth_((function (){var G__35196 = cljs.core.constant$keyword$102;
var G__35197 = expr__35190;
return (pred__35189.cljs$core$IFn$_invoke$arity$2 ? pred__35189.cljs$core$IFn$_invoke$arity$2(G__35196,G__35197) : pred__35189.call(null,G__35196,G__35197));
})())){
...
if(cljs.core.truth_((function (){var G__35198 = cljs.core.constant$keyword$103;
var G__35199 = expr__35190;
return (pred__35189.cljs$core$IFn$_invoke$arity$2 ? pred__35189.cljs$core$IFn$_invoke$arity$2(G__35198,G__35199) : pred__35189.call(null,G__35198,G__35199));
})())){
...
if(cljs.core.truth_((function (){var G__35200 = cljs.core.constant$keyword$104;
var G__35201 = expr__35190;
return (pred__35189.cljs$core$IFn$_invoke$arity$2 ? pred__35189.cljs$core$IFn$_invoke$arity$2(G__35200,G__35201) : pred__35189.call(null,G__35200,G__35201));
})())){
...
return (new cljs.core.async.impl.ioc_helpers.ExceptionFrame(self__.catch_block,self__.catch_exception,self__.finally_block,self__.continue_block,self__.prev,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4862__auto__,G__35185),null));
}
}
}
}
...
cljs.core.async.impl.ioc_helpers.ExceptionFrame.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4853__auto__,G__35185){
var self__ = this;
...
cljs.core.async.impl.ioc_helpers.map__GT_ExceptionFrame = (function map__GT_ExceptionFrame(G__35187){
return (new cljs.core.async.impl.ioc_helpers.ExceptionFrame(cljs.core.constant$keyword$100.cljs$core$IFn$_invoke$arity$1(G__35187),cljs.core.constant$keyword$101.cljs$core$IFn$_invoke$arity$1(G__35187),cljs.core.constant$keyword$102.cljs$core$IFn$_invoke$arity$1(G__35187),cljs.core.constant$keyword$103.cljs$core$IFn$_invoke$arity$1(G__35187),cljs.core.constant$keyword$104.cljs$core$IFn$_invoke$arity$1(G__35187),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__35187,cljs.core.constant$keyword$100,cljs.core.array_seq([cljs.core.constant$keyword$101,cljs.core.constant$keyword$102,cljs.core.constant$keyword$103,cljs.core.constant$keyword$104], 0)),null));
});

cljs.core.async.impl.ioc_helpers.add_exception_frame = (function add_exception_frame(state,catch_block,catch_exception,finally_block,continue_block){
var statearr_35204 = state;
(statearr_35204[cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES] = cljs.core.async.impl.ioc_helpers.__GT_ExceptionFrame(catch_block,catch_exception,finally_block,continue_block,cljs.core.async.impl.ioc_helpers.aget_object(state,cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES)));
...
var statearr_35210 = state;
(statearr_35210[cljs.core.async.impl.ioc_helpers.STATE_IDX] = catch_block);

(statearr_35210[cljs.core.async.impl.ioc_helpers.VALUE_IDX] = exception);

(statearr_35210[cljs.core.async.impl.ioc_helpers.CURRENT_EXCEPTION] = null);

(statearr_35210[cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES] = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(exception_frame,cljs.core.constant$keyword$100,null,cljs.core.array_seq([cljs.core.constant$keyword$101,null], 0)));
...
var statearr_35211_35215 = state;
(statearr_35211_35215[cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES] = cljs.core.constant$keyword$104.cljs$core$IFn$_invoke$arity$1(exception_frame));
...
(statearr_35212[cljs.core.async.impl.ioc_helpers.STATE_IDX] = cljs.core.constant$keyword$102.cljs$core$IFn$_invoke$arity$1(exception_frame));

(statearr_35212[cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES] = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(exception_frame,cljs.core.constant$keyword$102,null));
...
var statearr_35213 = state;
(statearr_35213[cljs.core.async.impl.ioc_helpers.STATE_IDX] = cljs.core.constant$keyword$102.cljs$core$IFn$_invoke$arity$1(exception_frame));

(statearr_35213[cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES] = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(exception_frame,cljs.core.constant$keyword$102,null));
...
var statearr_35214 = state;
(statearr_35214[cljs.core.async.impl.ioc_helpers.STATE_IDX] = cljs.core.constant$keyword$103.cljs$core$IFn$_invoke$arity$1(exception_frame));

(statearr_35214[cljs.core.async.impl.ioc_helpers.EXCEPTION_FRAMES] = cljs.core.constant$keyword$104.cljs$core$IFn$_invoke$arity$1(exception_frame));
