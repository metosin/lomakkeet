...
return cljs.core._write(writer__4216__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_31660 = (self__.level + (1));
while(true){
if((i_31660 <= (new_level + (1)))){
(update[i_31660] = self__.header);
...
var i_31662 = (0);
while(true){
if((i_31662 <= self__.level)){
var links_31663 = (update[i_31662]).forward;
if(((links_31663[i_31662]) === x__$1)){
(links_31663[i_31662] = (x__$1.forward[i_31662]));

var G__31664 = (i_31662 + (1));
i_31662 = G__31664;
continue;
} else {
var G__31665 = (i_31662 + (1));
i_31662 = G__31665;
continue;
}
} else {
...
if(!((nx == null))){
var G__31667 = nx;
var G__31668 = (level__$1 - (1));
x = G__31667;
level__$1 = G__31668;
continue;
} else {
var G__31669 = x;
var G__31670 = (level__$1 - (1));
x = G__31669;
level__$1 = G__31670;
continue;
}
...
var G__31672 = nx;
var G__31673 = (level__$1 - (1));
x = G__31672;
level__$1 = G__31673;
continue;
} else {
var G__31674 = x;
var G__31675 = (level__$1 - (1));
x = G__31674;
level__$1 = G__31675;
continue;
}
...
return cljs.core._write(writer__4216__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3628__auto__,timeout__$1,me){
return (function (){
