...
})(),(function (){var iter__4514__auto__ = (function iter__36629(s__36630){
return (new cljs.core.LazySeq(null,(function (){
var s__36630__$1 = s__36630;
while(true){
var temp__4126__auto__ = cljs.core.seq(s__36630__$1);
if(temp__4126__auto__){
var s__36630__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_(s__36630__$2)){
var c__4512__auto__ = cljs.core.chunk_first(s__36630__$2);
var size__4513__auto__ = cljs.core.count(c__4512__auto__);
var b__36632 = cljs.core.chunk_buffer(size__4513__auto__);
if((function (){var i__36631 = (0);
while(true){
if((i__36631 < size__4513__auto__)){
var vec__36637 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4512__auto__,i__36631);
...
cljs.core.chunk_append(b__36632,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));

var G__36639 = (i__36631 + (1));
i__36631 = G__36639;
continue;
} else {
var G__36640 = (i__36631 + (1));
i__36631 = G__36640;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36632),iter__36629(cljs.core.chunk_rest(s__36630__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36632),null);
}
} else {
var vec__36638 = cljs.core.first(s__36630__$2);
...
if(cljs.core.truth_(v)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null),iter__36629(cljs.core.rest(s__36630__$2)));
} else {
var G__36641 = cljs.core.rest(s__36630__$2);
s__36630__$1 = G__36641;
continue;
}
}
} else {
...
var G__36642__i = 0, G__36642__a = new Array(arguments.length -  1);
while (G__36642__i < G__36642__a.length) {G__36642__a[G__36642__i] = arguments[G__36642__i + 1]; ++G__36642__i;}
  kvs = new cljs.core.IndexedSeq(G__36642__a,0);
} 
return assoc_when__delegate.call(this,m,kvs);};
assoc_when.cljs$lang$maxFixedArity = 1;
assoc_when.cljs$lang$applyTo = (function (arglist__36643){
var m = cljs.core.first(arglist__36643);
var kvs = cljs.core.rest(arglist__36643);
...
var args = null;
if (arguments.length > 1) {
var G__36644__i = 0, G__36644__a = new Array(arguments.length -  1);
while (G__36644__i < G__36644__a.length) {G__36644__a[G__36644__i] = arguments[G__36644__i + 1]; ++G__36644__i;}
  args = new cljs.core.IndexedSeq(G__36644__a,0);
} 
return format_STAR___delegate.call(this,fmt,args);};
format_STAR_.cljs$lang$maxFixedArity = 1;
format_STAR_.cljs$lang$applyTo = (function (arglist__36645){
var fmt = cljs.core.first(arglist__36645);
...
var G__36647 = x;
if(G__36647){
var bit__4439__auto__ = (G__36647.cljs$lang$protocol_mask$partition0$ & (67108864));
if((bit__4439__auto__) || (G__36647.cljs$core$IRecord$)){
return true;
} else {
if((!G__36647.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_(cljs.core.IRecord,G__36647);
} else {
return false;
}
}
...
var self__ = this;
var this$__$1 = this;
return cljs.core._pr_writer((function (){var G__36648 = this$__$1;
return (schema.utils.validation_error_explain.cljs$core$IFn$_invoke$arity$1 ? schema.utils.validation_error_explain.cljs$core$IFn$_invoke$arity$1(G__36648) : schema.utils.validation_error_explain.call(null,G__36648));
})(),writer,opts);
});
...
return cljs.core._conj(cljs.core._conj(cljs.core.List.EMPTY,(function (){var G__36650 = err.expectation_delay;
return (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(G__36650) : cljs.core.deref.call(null,G__36650));
...
var self__ = this;
var this$__$1 = this;
return cljs.core._pr_writer((function (){var G__36651 = this$__$1;
return (schema.utils.named_error_explain.cljs$core$IFn$_invoke$arity$1 ? schema.utils.named_error_explain.cljs$core$IFn$_invoke$arity$1(G__36651) : schema.utils.named_error_explain.call(null,G__36651));
})(),writer,opts);
});
...
schema.utils.ErrorContainer.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4363__auto__,k36653,else__4364__auto__){
var self__ = this;
var this__4363__auto____$1 = this;
var G__36655 = (((k36653 instanceof cljs.core.Keyword))?k36653.fqn:null);
switch (G__36655) {
case "error":
return self__.error;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36653,else__4364__auto__);
...
;
return cljs.core.pr_sequential_writer(writer__4376__auto__,pr_pair__4378__auto__,"#schema.utils.ErrorContainer{",", ","}",opts__4377__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.constant$keyword$22,self__.error],null))], null),self__.__extmap));
});
...
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$22,null], null), null),k__4371__auto__)){
...
schema.utils.ErrorContainer.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4368__auto__,k__4369__auto__,G__36652){
var self__ = this;
var this__4368__auto____$1 = this;
var pred__36656 = cljs.core.keyword_identical_QMARK_;
var expr__36657 = k__4369__auto__;
if(cljs.core.truth_((function (){var G__36659 = cljs.core.constant$keyword$22;
var G__36660 = expr__36657;
return (pred__36656.cljs$core$IFn$_invoke$arity$2 ? pred__36656.cljs$core$IFn$_invoke$arity$2(G__36659,G__36660) : pred__36656.call(null,G__36659,G__36660));
})())){
return (new schema.utils.ErrorContainer(G__36652,self__.__meta,self__.__extmap,null));
} else {
return (new schema.utils.ErrorContainer(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4369__auto__,G__36652),null));
}
});
...
schema.utils.ErrorContainer.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4360__auto__,G__36652){
var self__ = this;
var this__4360__auto____$1 = this;
return (new schema.utils.ErrorContainer(self__.error,G__36652,self__.__extmap,self__.__hash));
});
...
schema.utils.map__GT_ErrorContainer = (function map__GT_ErrorContainer(G__36654){
return (new schema.utils.ErrorContainer(cljs.core.constant$keyword$22.cljs$core$IFn$_invoke$arity$1(G__36654),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__36654,cljs.core.constant$keyword$22),null));
});
...
var G__36665 = m;
return (lift_to_error.cljs$core$IFn$_invoke$arity$1 ? lift_to_error.cljs$core$IFn$_invoke$arity$1(G__36665) : lift_to_error.call(null,G__36665));
}
})(),err));
} else {
...
schema.utils.PSimpleCell = (function (){var obj36667 = {};
return obj36667;
})();
...
return (function (){var or__3758__auto__ = (schema.utils.get_cell[(function (){var G__36671 = x__4402__auto__;
return goog.typeOf(G__36671);
})()]);
if(or__3758__auto__){
return or__3758__auto__;
} else {
...
var x__4402__auto__ = (((this$ == null))?null:this$);
return (function (){var or__3758__auto__ = (schema.utils.set_cell[(function (){var G__36675 = x__4402__auto__;
return goog.typeOf(G__36675);
})()]);
if(or__3758__auto__){
return or__3758__auto__;
} else {
