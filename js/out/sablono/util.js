...
sablono.util.ToString = (function (){var obj34861 = {};
return obj34861;
})();
...
return (function (){var or__3758__auto__ = (sablono.util.to_str[(function (){var G__34865 = x__4402__auto__;
return goog.typeOf(G__34865);
})()]);
if(or__3758__auto__){
...
sablono.util.ToURI = (function (){var obj34867 = {};
return obj34867;
})();
...
var x__4402__auto__ = (((x == null))?null:x);
return (function (){var or__3758__auto__ = (sablono.util.to_uri[(function (){var G__34871 = x__4402__auto__;
return goog.typeOf(G__34871);
})()]);
if(or__3758__auto__){
return or__3758__auto__;
} else {
...
while (G__34872__i < G__34872__a.length) {G__34872__a[G__34872__i] = arguments[G__34872__i + 0]; ++G__34872__i;}
  xs = new cljs.core.IndexedSeq(G__34872__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__34873){
var xs = cljs.core.seq(arglist__34873);
...
var vec__34875 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34875,(0),null);
var words = cljs.core.nthnext(vec__34875,(1));
...
var G__34877 = clojure.set.rename_keys(m,kmap);
var G__34877__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$115.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34877,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$115], null),camel_case_keys):G__34877);
return G__34877__$1;
} else {
return m;
}
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34878_SHARP_){
if(cljs.core.list_QMARK_(p1__34878_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__34878_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__34878_SHARP_)){
...
while (G__34879__i < G__34879__a.length) {G__34879__a[G__34879__i] = arguments[G__34879__i + 0]; ++G__34879__i;}
  maps = new cljs.core.IndexedSeq(G__34879__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__34880){
var maps = cljs.core.seq(arglist__34880);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__34884,tag_name,names){
return (function (p1__34881_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34881_SHARP_));
});})(matches,vec__34884,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__34884,tag_name,names){
return (function (p1__34882_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34882_SHARP_));
});})(matches,vec__34884,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__34885){
var vec__34888 = p__34885;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34888,(0),null);
var content = cljs.core.nthnext(vec__34888,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str(tag),cljs.core.str(" is not a valid element name.")].join(''),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$62,tag,cljs.core.constant$keyword$120,content], null));
} else {
}

var vec__34889 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34889,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34889,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34889,(2),null);
