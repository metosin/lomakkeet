...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (l__$1,p__36174){
...
while (G__36183__i < G__36183__a.length) {G__36183__a[G__36183__i] = arguments[G__36183__i + 0]; ++G__36183__i;}
  values = new cljs.core.IndexedSeq(G__36183__a,0);
} 
return deep_merge__delegate.call(this,values);};
deep_merge.cljs$lang$maxFixedArity = 0;
deep_merge.cljs$lang$applyTo = (function (arglist__36184){
var values = cljs.core.seq(arglist__36184);
...
var G__36188__delegate = function (m,key,val,kvs){
while(true){
var ret = assoc_if.cljs$core$IFn$_invoke$arity$3(m,key,val);
if(cljs.core.truth_(kvs)){
if(cljs.core.next(kvs)){
var G__36189 = ret;
var G__36190 = cljs.core.first(kvs);
var G__36191 = cljs.core.second(kvs);
var G__36192 = cljs.core.nnext(kvs);
m = G__36189;
key = G__36190;
val = G__36191;
kvs = G__36192;
...
var G__36188 = function (m,key,val,var_args){
var kvs = null;
if (arguments.length > 3) {
var G__36193__i = 0, G__36193__a = new Array(arguments.length -  3);
while (G__36193__i < G__36193__a.length) {G__36193__a[G__36193__i] = arguments[G__36193__i + 3]; ++G__36193__i;}
  kvs = new cljs.core.IndexedSeq(G__36193__a,0);
} 
return G__36188__delegate.call(this,m,key,val,kvs);};
G__36188.cljs$lang$maxFixedArity = 3;
G__36188.cljs$lang$applyTo = (function (arglist__36194){
var m = cljs.core.first(arglist__36194);
arglist__36194 = cljs.core.next(arglist__36194);
var key = cljs.core.first(arglist__36194);
arglist__36194 = cljs.core.next(arglist__36194);
var val = cljs.core.first(arglist__36194);
var kvs = cljs.core.rest(arglist__36194);
return G__36188__delegate(m,key,val,kvs);
});
...
var G__36195 = null;
if (arguments.length > 3) {
var G__36196__i = 0, G__36196__a = new Array(arguments.length -  3);
while (G__36196__i < G__36196__a.length) {G__36196__a[G__36196__i] = arguments[G__36196__i + 3]; ++G__36196__i;}
G__36195 = new cljs.core.IndexedSeq(G__36196__a,0);
}
return assoc_if__4.cljs$core$IFn$_invoke$arity$variadic(m,key,val, G__36195);
}
...
return (function (v){
return cljs.core.every_QMARK_((function (p__36199){
var vec__36200 = p__36199;
var where_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36200,(0),null);
var where_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36200,(1),null);
...
return (function (p1__36202_SHARP_,p2__36201_SHARP_){
if(cljs.core.truth_((function (){var G__36204 = p2__36201_SHARP_;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__36204) : pred.call(null,G__36204));
})())){
...
if(cljs.core.truth_((function (){var G__36207 = p1__36205_SHARP_;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__36207) : pred.call(null,G__36207));
})())){
return p1__36205_SHARP_;
} else {
return null;
}
});})(pred))
...
return (function (x){
if(cljs.core.truth_((function (){var G__36209 = x;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__36209) : pred.call(null,G__36209));
})())){
return v;
} else {
return x;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (pred){
return (function (x){
if(cljs.core.truth_((function (){var G__36211 = x;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__36211) : pred.call(null,G__36211));
})())){
...
var args = null;
if (arguments.length > 3) {
var G__36212__i = 0, G__36212__a = new Array(arguments.length -  3);
while (G__36212__i < G__36212__a.length) {G__36212__a[G__36212__i] = arguments[G__36212__i + 3]; ++G__36212__i;}
  args = new cljs.core.IndexedSeq(G__36212__a,0);
} 
return update_first__delegate.call(this,coll,where,f,args);};
update_first.cljs$lang$maxFixedArity = 3;
update_first.cljs$lang$applyTo = (function (arglist__36213){
var coll = cljs.core.first(arglist__36213);
arglist__36213 = cljs.core.next(arglist__36213);
var where = cljs.core.first(arglist__36213);
arglist__36213 = cljs.core.next(arglist__36213);
var f = cljs.core.first(arglist__36213);
var args = cljs.core.rest(arglist__36213);
...
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(acc,(function (){var G__36215 = k;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36215) : f.call(null,G__36215));
})(),v);
...
return cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (acc,k,v){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(acc,k,(function (){var G__36217 = v;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36217) : f.call(null,G__36217));
})());
}),cljs.core.transient$(cljs.core.empty(coll)),coll));
});
