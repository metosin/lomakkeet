...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (l__$1,p__29789){
...
*/
potpuri.core.dissoc_in = (function dissoc_in(m,p__29791){
var vec__29795 = p__29791;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29795,(0),null);
var ks = cljs.core.nthnext(vec__29795,(1));
var keys = vec__29795;
if(ks){
...
var vec__29797 = (((cljs.core.first(values) instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.rest(values),cljs.core.first(values)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [values,cljs.core.constant$keyword$185], null));
var values__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29797,(0),null);
var strategy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29797,(1),null);
...
if((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(strategy,cljs.core.constant$keyword$186)) && (cljs.core.every_QMARK_(cljs.core.coll_QMARK_,values__$1))){
...
while (G__29798__i < G__29798__a.length) {G__29798__a[G__29798__i] = arguments[G__29798__i + 0]; ++G__29798__i;}
  values = new cljs.core.IndexedSeq(G__29798__a,0);
} 
return deep_merge__delegate.call(this,values);};
deep_merge.cljs$lang$maxFixedArity = 0;
deep_merge.cljs$lang$applyTo = (function (arglist__29799){
var values = cljs.core.seq(arglist__29799);
...
var G__29803__delegate = function (m,key,val,kvs){
while(true){
var ret = assoc_if.cljs$core$IFn$_invoke$arity$3(m,key,val);
if(cljs.core.truth_(kvs)){
if(cljs.core.next(kvs)){
var G__29804 = ret;
var G__29805 = cljs.core.first(kvs);
var G__29806 = cljs.core.second(kvs);
var G__29807 = cljs.core.nnext(kvs);
m = G__29804;
key = G__29805;
val = G__29806;
kvs = G__29807;
...
var G__29803 = function (m,key,val,var_args){
var kvs = null;
if (arguments.length > 3) {
var G__29808__i = 0, G__29808__a = new Array(arguments.length -  3);
while (G__29808__i < G__29808__a.length) {G__29808__a[G__29808__i] = arguments[G__29808__i + 3]; ++G__29808__i;}
  kvs = new cljs.core.IndexedSeq(G__29808__a,0);
} 
return G__29803__delegate.call(this,m,key,val,kvs);};
G__29803.cljs$lang$maxFixedArity = 3;
G__29803.cljs$lang$applyTo = (function (arglist__29809){
var m = cljs.core.first(arglist__29809);
arglist__29809 = cljs.core.next(arglist__29809);
var key = cljs.core.first(arglist__29809);
arglist__29809 = cljs.core.next(arglist__29809);
var val = cljs.core.first(arglist__29809);
var kvs = cljs.core.rest(arglist__29809);
return G__29803__delegate(m,key,val,kvs);
});
...
var G__29810 = null;
if (arguments.length > 3) {
var G__29811__i = 0, G__29811__a = new Array(arguments.length -  3);
while (G__29811__i < G__29811__a.length) {G__29811__a[G__29811__i] = arguments[G__29811__i + 3]; ++G__29811__i;}
G__29810 = new cljs.core.IndexedSeq(G__29811__a,0);
}
return assoc_if__4.cljs$core$IFn$_invoke$arity$variadic(m,key,val, G__29810);
}
...
return (function (v){
return cljs.core.every_QMARK_((function (p__29814){
var vec__29815 = p__29814;
var where_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29815,(0),null);
var where_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29815,(1),null);
...
return (function (p1__29817_SHARP_,p2__29816_SHARP_){
if(cljs.core.truth_((function (){var G__29819 = p2__29816_SHARP_;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__29819) : pred.call(null,G__29819));
})())){
return p1__29817_SHARP_;
} else {
return null;
}
});})(pred))
...
if(cljs.core.truth_((function (){var G__29822 = p1__29820_SHARP_;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__29822) : pred.call(null,G__29822));
})())){
return p1__29820_SHARP_;
} else {
return null;
}
});})(pred))
...
return (function (x){
if(cljs.core.truth_((function (){var G__29824 = x;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__29824) : pred.call(null,G__29824));
})())){
return v;
} else {
return x;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (pred){
return (function (x){
if(cljs.core.truth_((function (){var G__29826 = x;
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__29826) : pred.call(null,G__29826));
})())){
...
var args = null;
if (arguments.length > 3) {
var G__29827__i = 0, G__29827__a = new Array(arguments.length -  3);
while (G__29827__i < G__29827__a.length) {G__29827__a[G__29827__i] = arguments[G__29827__i + 3]; ++G__29827__i;}
  args = new cljs.core.IndexedSeq(G__29827__a,0);
} 
return update_first__delegate.call(this,coll,where,f,args);};
update_first.cljs$lang$maxFixedArity = 3;
update_first.cljs$lang$applyTo = (function (arglist__29828){
var coll = cljs.core.first(arglist__29828);
arglist__29828 = cljs.core.next(arglist__29828);
var where = cljs.core.first(arglist__29828);
arglist__29828 = cljs.core.next(arglist__29828);
var f = cljs.core.first(arglist__29828);
var args = cljs.core.rest(arglist__29828);
...
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(acc,(function (){var G__29830 = k;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29830) : f.call(null,G__29830));
})(),v);
...
return cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (acc,k,v){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(acc,k,(function (){var G__29832 = v;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29832) : f.call(null,G__29832));
})());
}),cljs.core.transient$(cljs.core.empty(coll)),coll));
});
