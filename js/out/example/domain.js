 ...
 * 
 */
example.domain.Thingie = cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(schema.core.schema_with_name(new cljs.core.PersistentArrayMap(null, 8, [cljs.core.constant$keyword$name,schema.core.both.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([schema.core.Str,schema.core.pred.cljs$core$IFn$_invoke$arity$2(cljs.core.seq,new cljs.core.Symbol(null,"required","required",-846788763,null))], 0)),cljs.core.constant$keyword$email,schema.core.both.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([schema.core.Str,schema.core.pred.cljs$core$IFn$_invoke$arity$2((function (p1__11823_SHARP_){
return cljs.core.re_find(example.domain.email_pattern,p1__11823_SHARP_);
...
example.domain.ThingieDates = (function example$domain$ThingieDates(p__11825){
var map__11828 = p__11825;
var map__11828__$1 = ((cljs.core.seq_QMARK_(map__11828))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11828):map__11828);
var map__11829 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11828__$1,cljs.core.constant$keyword$dates);
var map__11829__$1 = ((cljs.core.seq_QMARK_(map__11829))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11829):map__11829);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11829__$1,cljs.core.constant$keyword$start);
var end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11829__$1,cljs.core.constant$keyword$end);
return cljs.core.assoc_in(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(example.domain.Thingie,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$dates,cljs.core.constant$keyword$start], null),((function (map__11828,map__11828__$1,map__11829,map__11829__$1,start,end){
return (function (p1__11824_SHARP_){
return schema.core.both.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([p1__11824_SHARP_,example.domain.DateRange(cljs_time.core.today(),end)], 0));
});})(map__11828,map__11828__$1,map__11829,map__11829__$1,start,end))
