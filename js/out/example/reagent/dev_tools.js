...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$ul,(function (){var iter__5092__auto__ = (function example$reagent$dev_tools$tree_$_iter__12255(s__12256){
return (new cljs.core.LazySeq(null,(function (){
var s__12256__$1 = s__12256;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__12256__$1);
if(temp__4425__auto__){
var s__12256__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12256__$2)){
var c__5090__auto__ = cljs.core.chunk_first(s__12256__$2);
var size__5091__auto__ = cljs.core.count(c__5090__auto__);
var b__12258 = cljs.core.chunk_buffer(size__5091__auto__);
if((function (){var i__12257 = (0);
while(true){
if((i__12257 < size__5091__auto__)){
var vec__12263 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5090__auto__,i__12257);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12263,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12263,(1),null);
var ks__$1 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ks,k);
cljs.core.chunk_append(b__12258,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$li,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$key,example.reagent.dev_tools.key__GT_string(k),cljs.core.constant$keyword$class,[cljs.core.str(((cljs.core.coll_QMARK_(v__$1))?"coll":"single")),cljs.core.str(" "),cljs.core.str((cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(tree_state,ks__$1))?"open":"closed"))].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$strong,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$on_DASH_click,((function (i__12257,ks__$1,vec__12263,k,v__$1,c__5090__auto__,size__5091__auto__,b__12258,s__12256__$2,temp__4425__auto__){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(tree_atom,example.reagent.dev_tools.toggle,ks__$1);
});})(i__12257,ks__$1,vec__12263,k,v__$1,c__5090__auto__,size__5091__auto__,b__12258,s__12256__$2,temp__4425__auto__))
...
})())?example$reagent$dev_tools$tree(tree_atom,tree_state,v__$1,ks__$1):null)], null),example$reagent$dev_tools$tree_$_iter__12255(cljs.core.rest(s__12256__$2)));
}
} else {
return null;
}
