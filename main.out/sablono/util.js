...
var len__6046__auto___15717 = arguments.length;
var i__6047__auto___15718 = (0);
while(true){
if((i__6047__auto___15718 < len__6046__auto___15717)){
args__6053__auto__.push((arguments[i__6047__auto___15718]));

var G__15719 = (i__6047__auto___15718 + (1));
i__6047__auto___15718 = G__15719;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq15716){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15716));
});
/**
...
var vec__15721 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__15721,(0),null);
var words = cljs.core.nthnext.call(null,vec__15721,(1));
...
var G__15723 = clojure.set.rename_keys.call(null,m,kmap);
var G__15723__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__15723,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__15723);
return G__15723__$1;
} else {
return m;
}
...
var args__6053__auto__ = [];
var len__6046__auto___15726 = arguments.length;
var i__6047__auto___15727 = (0);
while(true){
if((i__6047__auto___15727 < len__6046__auto___15726)){
args__6053__auto__.push((arguments[i__6047__auto___15727]));

var G__15728 = (i__6047__auto___15727 + (1));
i__6047__auto___15727 = G__15728;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15724_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__15724_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15724_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__15724_SHARP_)){
return p1__15724_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15724_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq15725){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15725));
});
/**
...
var vec__15732 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__15732,(0),null);
var names = cljs.core.nth.call(null,vec__15732,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__15732,tag_name,names){
return (function (p1__15729_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__15729_SHARP_));
});})(matches,vec__15732,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__15732,tag_name,names){
return (function (p1__15730_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__15730_SHARP_));
});})(matches,vec__15732,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__15733){
var vec__15736 = p__15733;
var tag = cljs.core.nth.call(null,vec__15736,(0),null);
var content = cljs.core.nthnext.call(null,vec__15736,(1));
...
var vec__15737 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__15737,(0),null);
var id = cljs.core.nth.call(null,vec__15737,(1),null);
var class$ = cljs.core.nth.call(null,vec__15737,(2),null);
