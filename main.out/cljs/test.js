...
var args17154 = [];
var len__6046__auto___17158 = arguments.length;
var i__6047__auto___17159 = (0);
while(true){
if((i__6047__auto___17159 < len__6046__auto___17158)){
args17154.push((arguments[i__6047__auto___17159]));

var G__17160 = (i__6047__auto___17159 + (1));
i__6047__auto___17159 = G__17160;
continue;
} else {
}
break;
...
var G__17157__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__17157,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__17157);
return G__17157__$1;
});
...
var len__6046__auto___17165 = arguments.length;
var i__6047__auto___17166 = (0);
while(true){
if((i__6047__auto___17166 < len__6046__auto___17165)){
args__6053__auto__.push((arguments[i__6047__auto___17166]));

var G__17167 = (i__6047__auto___17166 + (1));
i__6047__auto___17166 = G__17167;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17162){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__17163,G__17164,seq17162__$2);
});
...
var map__17171 = m;
var map__17171__$1 = ((((!((map__17171 == null)))?((((map__17171.cljs$lang$protocol_mask$partition0$ & (64))) || (map__17171.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__17171):map__17171);
var file = cljs.core.get.call(null,map__17171__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__17171__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17171__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__17171,map__17171__$1,file,line,column){
return (function (p1__17168_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17168_SHARP_));
});})(map__17171,map__17171__$1,file,line,column))
...
var temp__4425__auto___17173 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___17173)){
var message_17174 = temp__4425__auto___17173;
cljs.core.println.call(null,message_17174);
} else {
}
...
var temp__4425__auto___17175 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___17175)){
var message_17176 = temp__4425__auto___17175;
cljs.core.println.call(null,message_17176);
} else {
}
...
var G__17182 = exception.stack;
var G__17182__$1 = (((G__17182 == null))?null:clojure.string.split_lines.call(null,G__17182));
var G__17182__$2 = (((G__17182__$1 == null))?null:cljs.core.get.call(null,G__17182__$1,depth));
var G__17182__$3 = (((G__17182__$2 == null))?null:clojure.string.trim.call(null,G__17182__$2));
return G__17182__$3;
} else {
...
var vec__17183 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17183,(0),null);
var column = cljs.core.nth.call(null,vec__17183,(1),null);
var vec__17184 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17184,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17184,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17184,(2),null);
...
var m__$1 = (function (){var G__17186 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__17186) {
case "fail":
...
var G__17192 = (function (){var G__17191 = cljs.core.rest.call(null,fns);
var G__17191__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__17191):G__17191);
return G__17191__$1;
})();
fns = G__17192;
continue;
...
var G__17194 = fns;
var G__17194__$1 = (((G__17194 == null))?null:cljs.core.vary_meta.call(null,G__17194,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__17194__$1;
});
...
var G__17198 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__17198) {
...
var vec__17201 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17201,(0),null);
var types = vec__17201;
...
return cljs.core.map.call(null,(function (p__17209){
var vec__17210 = p__17209;
var ns = cljs.core.nth.call(null,vec__17210,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17210,(1),null);
return ((function (vec__17210,ns,vars__$1){
return (function (){
...
var G__17211 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__17211) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1){
return (function (){
var seq__17212 = cljs.core.seq.call(null,vars__$1);
var chunk__17213 = null;
var count__17214 = (0);
var i__17215 = (0);
while(true){
if((i__17215 < count__17214)){
var v = cljs.core._nth.call(null,chunk__17213,i__17215);
var temp__4425__auto___17217 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___17217)){
var t_17218 = temp__4425__auto___17217;
each_fixture_fn.call(null,((function (seq__17212,chunk__17213,count__17214,i__17215,t_17218,temp__4425__auto___17217,v,each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17218)));
});})(seq__17212,chunk__17213,count__17214,i__17215,t_17218,temp__4425__auto___17217,v,each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1))
);
} else {
}

var G__17219 = seq__17212;
var G__17220 = chunk__17213;
var G__17221 = count__17214;
var G__17222 = (i__17215 + (1));
seq__17212 = G__17219;
chunk__17213 = G__17220;
count__17214 = G__17221;
i__17215 = G__17222;
continue;
} else {
...
var c__5791__auto__ = cljs.core.chunk_first.call(null,seq__17212__$1);
var G__17223 = cljs.core.chunk_rest.call(null,seq__17212__$1);
var G__17224 = c__5791__auto__;
var G__17225 = cljs.core.count.call(null,c__5791__auto__);
var G__17226 = (0);
seq__17212 = G__17223;
chunk__17213 = G__17224;
count__17214 = G__17225;
i__17215 = G__17226;
continue;
} else {
var v = cljs.core.first.call(null,seq__17212__$1);
var temp__4425__auto___17227__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___17227__$1)){
var t_17228 = temp__4425__auto___17227__$1;
each_fixture_fn.call(null,((function (seq__17212,chunk__17213,count__17214,i__17215,t_17228,temp__4425__auto___17227__$1,v,seq__17212__$1,temp__4425__auto__,each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17228)));
});})(seq__17212,chunk__17213,count__17214,i__17215,t_17228,temp__4425__auto___17227__$1,v,seq__17212__$1,temp__4425__auto__,each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1))
);
} else {
}

var G__17229 = cljs.core.next.call(null,seq__17212__$1);
var G__17230 = null;
var G__17231 = (0);
var G__17232 = (0);
seq__17212 = G__17229;
chunk__17213 = G__17230;
count__17214 = G__17231;
i__17215 = G__17232;
continue;
}
} else {
...
});})(each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1))
);
});})(each_fixture_fn,G__17211,env,once_fixtures,each_fixtures,vec__17210,ns,vars__$1))
], null);
