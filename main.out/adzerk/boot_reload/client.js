...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__18605,opts){
...
var files = cljs.core.get.call(null,map__18606__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6046__auto___18612 = arguments.length;
var i__6047__auto___18613 = (0);
while(true){
if((i__6047__auto___18613 < len__6046__auto___18612)){
args__6053__auto__.push((arguments[i__6047__auto___18613]));

var G__18614 = (i__6047__auto___18613 + (1));
i__6047__auto___18613 = G__18614;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__18610){
var vec__18611 = p__18610;
var opts = cljs.core.nth.call(null,vec__18611,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__18611,opts){
return (function (evt){
...
});})(conn,vec__18611,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__18611,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__18611,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__18611,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq18608){
var G__18609 = cljs.core.first.call(null,seq18608);
var seq18608__$1 = cljs.core.next.call(null,seq18608);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__18609,seq18608__$1);
});
