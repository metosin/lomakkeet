...
return (function (p__14432){
var vec__14433 = p__14432;
var attr = cljs.core.nth.call(null,vec__14433,(0),null);
...
var args14434 = [];
var len__6046__auto___14437 = arguments.length;
var i__6047__auto___14438 = (0);
while(true){
if((i__6047__auto___14438 < len__6046__auto___14437)){
args14434.push((arguments[i__6047__auto___14438]));

var G__14439 = (i__6047__auto___14438 + (1));
i__6047__auto___14438 = G__14439;
continue;
} else {
}
break;
...
var len__6046__auto___14442 = arguments.length;
var i__6047__auto___14443 = (0);
while(true){
if((i__6047__auto___14443 < len__6046__auto___14442)){
args__6053__auto__.push((arguments[i__6047__auto___14443]));

var G__14444 = (i__6047__auto___14443 + (1));
i__6047__auto___14443 = G__14444;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq14441){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14441));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__14445){
var map__14449 = p__14445;
...
var data = map__14449__$1;
var message = cljs.core.get.call(null,map__14449__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__14449__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__14449__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__14451 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__14451,goog.events.EventType.CLICK,((function (G__14451,map__14449,map__14449__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__14451,map__14449,map__14449__$1,data,message,line,file))
);

return G__14451;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__14452){
var map__14456 = p__14452;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__14459){
var map__14463 = p__14459;
var map__14463__$1 = ((((!((map__14463 == null)))?((((map__14463.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14463.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14463):map__14463);
var messages = map__14463__$1;
var warnings = cljs.core.get.call(null,map__14463__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__14463__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__14465 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__14465,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__14465,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__14466){
var map__14469 = p__14466;
var map__14469__$1 = ((((!((map__14469 == null)))?((((map__14469.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14469.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14469):map__14469);
var messages = map__14469__$1;
var warnings = cljs.core.get.call(null,map__14469__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__14469__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__14469,map__14469__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__14469,map__14469__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__14469,map__14469__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__14469,map__14469__$1,messages,warnings,exception))
;
...
}catch (e14472){if((e14472 instanceof Error)){
var __14473 = e14472;
} else {
throw e14472;
